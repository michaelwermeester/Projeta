...
#define DISCLOSURE_TRIANGLE_SPACE				0.0		//The indentation reserved for disclosure triangles for non-group items
...
// mw - implement getter to avoid compiler warning
- (NSSize)iconSize
{
    return _iconSize;
}
